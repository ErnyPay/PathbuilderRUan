...
# Wizard 3: standard prepared casting.
...
grep -q 'подготовленные' wizard32-top.xml || { adb logcat -d -v time | tail -n 700; cat wizard32-top.xml; exit 1; }
...
# Bard 3: standard spontaneous casting.
...
grep -q 'спонтанные' bard32-top.xml || { adb logcat -d -v time | tail -n 700; cat bard32-top.xml; exit 1; }
